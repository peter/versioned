(ns content-api.model-spec
  (:require [content-api.routes :refer [crud-actions]]
            [content-api.util.core :as u]
            [content-api.model-callbacks :refer [normalize-callbacks merge-callbacks sort-callbacks]]
            [content-api.model-relationships :refer [normalized-relationships]]
